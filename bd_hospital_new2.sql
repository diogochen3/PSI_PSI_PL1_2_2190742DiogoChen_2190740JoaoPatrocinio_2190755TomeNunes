...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 24-Nov-2020 às 15:10
...
INSERT INTO `marcacao` (`id`, `date`, `id_especialidade`) VALUES
(1, '0000-00-00', 1),
(2, '2020-11-04', 1),
(3, '2008-11-11', 1);
...
ALTER TABLE `consultas`
  ADD CONSTRAINT `fk_marcacao` FOREIGN KEY (`id_marcacao`) REFERENCES `marcacao` (`id`);
